...
import { Filter, MapPin, Layers, Info, X, ChevronDown, ChevronUp } from 'lucide-react';
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                          <span className={`font-medium ${
                            selectedCategory === cat.id ? 'text-blue-700' : 'text-gray-800'
                          }`}>
                            {cat.name}
                          </span>
                          {cat.id !== 'all' && (
          ...
          <div className="absolute top-4 right-4 z-[1000] flex flex-col gap-2">
            ...
            {selectedPoi && (
              <button
                ...
                className={`p-3 rounded-lg shadow-lg hover:shadow-xl transition flex items-center gap-2 ${
                  showInfoPanel ? 'bg-blue-100 text-blue-700' : 'bg-white text-gray-700'
                }`}
